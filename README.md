...
[![CI][ci]](https://github.com/tree-sitter/tree-sitter-clean/actions/workflows/ci.yml)
...
[ci]: https://img.shields.io/github/actions/workflow/status/tree-sitter/tree-sitter-clean/ci.yml?logo=github&label=CI
